...
# PHP
RUN apt-get -y install php5 libapache2-mod-php5 php5-mcrypt php5-pgsql php5-cli php5-curl
...
### START CONTAINER
#docker run -d -it -p 8888:8888 --name project -v `pwd`:/home/application/project -w /home/application/project --link phppgadmindocker_db_1 -it --net phppgadmindocker_default project:0.2
# REMOVE - container <none> --> docker rmi -f $(docker images | grep "<none>" | awk "{print \$3}")
